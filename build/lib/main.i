...
static inline void draw_arrow(void) {
  if (dot_y_vel > 0) {
    Moveto_d(0x12, 0);
    Draw_Line_d(0x12, 0);
    Draw_Line_d(-0x12/2, -0x12/2);
    Moveto_d(0x12/2, 0x12/2);
    Draw_Line_d(-0x12/2, 0x12/2);
  } else {
    Moveto_d(-0x12, 0);
    Draw_Line_d(-0x12, 0);
...
static void move_paddles(void) {
  ...
  if (button_1_1_held() && player1_x > -120) {
    player1_x -= 3;
  }
  if (button_1_2_held() && player1_x + 0x24 < 120) {
    player1_x += 3;
  }
  if (button_1_3_held() && player2_x > - 120) {
    player2_x -= 3;
  }
  if (button_1_4_held() && player2_x + 0x24 < 120) {
    player2_x += 3;
  }
}
